...
<title>Outreach — Twilio + AI Photo Generator</title>
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hdr h1 { font-size: clamp(20px, 1.6vw, 28px); font-weight: 700; color: #F7F8F8; letter-spacing: -0.3px; }
  ...
  .ev-pick-label { font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: .8px; color: #4D5562; padding-left: 2px; }
  .ev-sel {
  ...
  .stat .lbl { font-size: 12px; color: #636B78; text-transform: uppercase; letter-spacing: .6px; font-weight: 500; margin-top: 4px; }
  ...
  .sel-count { font-size: 13px; color: #4B8BF5; font-weight: 500; }
  ...
  .urow {
    ...
    border-bottom: 1px solid #1E222B; font-size: 14px; transition: background .15s;
  }
  ...
  .uphone { font-family: monospace; color: #B0B8C4; min-width: 110px; font-size: 13.5px; }
  .ucnt { color: #8B95A5; min-width: 55px; font-size: 13px; }
  .ustyles { display: flex; gap: 4px; flex-wrap: wrap; flex: 1; }
  .upill { font-size: 11px; padding: 2px 8px; border-radius: 8px; color: #fff; white-space: nowrap; font-weight: 500; }
  .utime { color: #4D5562; font-size: 12px; min-width: 50px; text-align: right; flex-shrink: 0; }
  ...
  .compose-ta {
    ...
    color: #B0B8C4; padding: 12px 14px; font-size: 14px; font-family: inherit;
  ...
  .winner-entry {
    ...
    background: #0B0D11; border: 1px solid #1E222B; border-radius: 8px; font-size: 13px;
  }
  ...
  /* Lead capture */
  .lead-stat { display: flex; align-items: baseline; gap: 8px; margin-bottom: 12px; }
  .lead-stat .val { font-size: 28px; font-weight: 700; color: #9B6FE8; font-variant-numeric: tabular-nums; }
  .lead-stat .lbl { font-size: 13px; color: #636B78; }
  .btn-export {
    width: 100%; background: #9B6FE818; color: #9B6FE8; border: 1px solid #9B6FE844;
    border-radius: 10px; padding: 10px 18px; font-size: 14px; font-weight: 600;
    cursor: pointer; font-family: inherit; transition: background .15s, border-color .15s;
    display: flex; align-items: center; justify-content: center; gap: 7px;
    text-decoration: none;
  }
  .btn-export:hover { background: #9B6FE828; border-color: #9B6FE8; }
  .btn-export svg { width: 16px; height: 16px; flex-shrink: 0; }
  .lead-table { width: 100%; border-collapse: collapse; margin-top: 12px; font-size: 13px; }
  .lead-table th {
    text-align: left; padding: 6px 8px; font-size: 11px; font-weight: 600;
    color: #4D5562; text-transform: uppercase; letter-spacing: .5px;
    border-bottom: 1px solid #1E222B;
  }
  .lead-table td { padding: 7px 8px; color: #B0B8C4; border-bottom: 1px solid #1A1E27; }
  .lead-table tr:last-child td { border-bottom: none; }
  .lead-table-wrap { max-height: 320px; overflow-y: auto; border: 1px solid #1E222B; border-radius: 10px; scrollbar-width: thin; scrollbar-color: #252A34 #13161D; }
  .lead-table-wrap::-webkit-scrollbar { width: 6px; }
  .lead-table-wrap::-webkit-scrollbar-track { background: #13161D; border-radius: 3px; }
...
<div class="panel" style="margin-top:16px">
  ...
  <div class="lead-table-wrap" style="margin-top:14px">
