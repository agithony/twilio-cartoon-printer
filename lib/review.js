...
router.get("/", (req, res) => {
    ...
    // Gate: human review must be enabled
...
function renderQueue(jobs) {
  ...
  for (var j of jobs) {
    ...
    h += '<div class="rv-img-wrap"><img src="'+origSrc+'" onclick="openModal(\\''+origSrc+'\\',\\'/images/staging/'+fp+'_output.png\\')" title="Click to compare"><span class="rv-img-label">Original</span></div>';
    h += '<div class="rv-img-wrap"><img src="'+imgSrc+'" onclick="openModal(\\''+origSrc+'\\',\\'/images/staging/'+fp+'_output.png\\')" title="Click to compare"><span class="rv-img-label">Generated</span></div>';
    h += '</div>';
...
function openModal(origSrc, genSrc) {
