...
function renderQueue(jobs) {
  ...
  for (var j of jobs) {
    ...
    h += '<button class="rv-btn rv-btn-reanalyze" onclick="doAction(\\''+fn+'\\',\\'reject\\',{reanalyze:true})" title="Re-generate with fresh analysis — optionally add instructions (e.g. fix the logo, include the dog)">Re-analyze</button>';
