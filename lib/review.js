...
<div class="wrap">
  ...
  <div class="rv-bulk-bar" id="rvBulkBar">
    ...
    <div class="rv-bulk-actions">
      <button class="rv-btn rv-btn-approve" onclick="bulkAction('approve')">Approve Selected</button>
      <button class="rv-btn rv-btn-reject" onclick="bulkAction('reject')">Reject Selected</button>
    </div>
  </div>
...
function renderQueue(jobs) {
  ...
  for (var j of jobs) {
    ...
    h += '<button class="rv-btn rv-btn-approve" onclick="doAction(\\''+fn+'\\',\\'approve\\')" title="Send to user">Approve</button>';
    h += '<div class="rv-reject-row">';
    h += '<button class="rv-btn rv-btn-reject" onclick="doAction(\\''+fn+'\\',\\'reject\\')" title="Discard">Reject</button>';
    h += '<button class="rv-btn rv-btn-notify" onclick="doAction(\\''+fn+'\\',\\'reject\\',{notify:true})" title="Reject + SMS user">Reject + Notify</button>';
    h += '<button class="rv-btn rv-btn-reanalyze" onclick="doAction(\\''+fn+'\\',\\'reject\\',{reanalyze:true})" title="Re-generate fresh">Re-analyze</button>';
    h += '</div></div></div>';
  }
  grid.innerHTML = h;
