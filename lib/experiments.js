...
function buildRouter() {
    ...
    router.get("/photos", async (req, res) => {
        ...
        const list = photos.map((p) => `
          <div class="card"><div class="row">
            <div>
              ...
              <div class="muted">${escapeHtml(p.filename)} · ${escapeHtml(new Date(p.uploadedAt).toLocaleDateString())}</div>
        ...
        const body = `
          ...
          <div class="card">
            <input type="file" id="file" accept="image/jpeg" aria-label="Test photo file">
            <input type="text" id="displayName" placeholder="Display name (optional)" aria-label="Display name (optional)">
          ...
          document.getElementById("upload").addEventListener("click", async () => {
              ...
              if (r.ok) location.reload();
                  ...
                  document.getElementById("msg").textContent = j.error || "Upload failed";
