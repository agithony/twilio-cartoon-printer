...
async function defaultCallImageEdit({ entry, promptText }) {
    ...
    // Exact background mode: composite the transparent portrait onto the literal uploaded background image.
    // Mirrors pipeline.js exact-background compositing so /eval matches production behavior.
