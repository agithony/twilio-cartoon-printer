...
async function defaultCallImageEdit({ entry, promptText }) {
    ...
    // Exact background mode: chroma-key the magenta fill the model was asked to
    // paint around the subject, then composite onto the literal uploaded
    // background image. Mirrors pipeline.js so /eval matches production.
