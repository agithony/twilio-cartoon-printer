...
const DEFAULT_COMPOSITION =
    "Composition: Portrait framing from the waist up, positioned naturally as they appear in the original photo.";
...
const STYLES = {
    cartoon: {
        ...
        core: "Pixar-style 3D animated portrait with warm color grading, subsurface skin glow, and rich tactile textures.",
