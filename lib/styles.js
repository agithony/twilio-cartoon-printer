...
const STYLES = {
    cartoon: {
        ...
        prompt: [
            ...
            PRESERVE_LINE + " The cartoon should be immediately recognizable as each person in the original photo.",
            ...
            COMPOSITION_LINE + " Give them a warm, friendly expression.",
