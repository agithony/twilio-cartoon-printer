...
const STYLES = {
    cartoon: {
        ...
        buildPrompt: (preserve, composition) => [
            "Transform this photo into a 3D animated character portrait in the style of Pixar and Disney Animation Studios (Coco, Up, Brave). Do not add anyone not in the original photo.",
