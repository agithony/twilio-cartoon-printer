...
const STYLES = {
    cartoon: {
        name: "cartoon",
        core: "3D cartoon caricature with exaggerated proportions, thick outlines, vibrant cel-shaded colors, and expressive simplified features.",
        brandCore: "Bold cartoon style with thick outlines and vibrant colors.",
        buildPrompt: (preserve, composition) => [
            "Transform this photo into a 3D cartoon caricature in the style of a modern animated film. Each subject should be a stylized cartoon version of the corresponding person (and any pets) in the photo.",
