...
<a href="/home" class="home-nav" title="Back to admin home">
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12l2-2m0 0l7-7 7 7m-9 9h4v-6h-4v6z"/></svg>
  Home
</a>
...
async function generate() {
    ...
    // Client-side sanity check — server re-validates. Catches typos before
    // we upload the whole image.
