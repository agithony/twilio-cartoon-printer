...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .theme-toggle {
    ...
    background: var(--th-card); border: 1px solid var(--th-card-border);
    color: var(--th-text-dim); cursor: pointer; display: flex;
    align-items: center; justify-content: center; font-size: 18px;
    transition: all .15s;
  }
  .theme-toggle:hover { border-color: var(--blue-300); }
...
<div class="wrap">
  <div class="header">
    <h1>Settings</h1>
    <a href="/review/queue" class="header-btn">
...
async function loadSettings() {
  try {
    ...
    document.getElementById('settingsBody').innerHTML = '<p style="color:var(--brand-red)">Failed to load settings.</p>';
  }
}
