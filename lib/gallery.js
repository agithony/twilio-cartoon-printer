...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .img-flipper {
    position: relative; max-width: 90%; max-height: 100%;
    perspective: 1000px;
  }
  .img-flipper .flip-inner {
    position: relative; transition: transform .6s ease; transform-style: preserve-3d;
  }
  .img-flipper.flipped .flip-inner { transform: rotateY(180deg); }
  .img-flipper img {
    max-width: 100%; max-height: 100%; object-fit: contain; border-radius: 6px;
    transition: opacity .4s ease; backface-visibility: hidden;
  }
...
<div class="gallery">
  ...
  <div class="viewer" id="viewer">
    ...
    <div class="toolbar">
      <div class="tool-btn" id="originalBtn" onclick="toggleOriginal()" title="Toggle between AI portrait and original selfie">&#x1F4F7; View Original</div>
