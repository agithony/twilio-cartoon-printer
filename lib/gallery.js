...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .counter {
    ...
    font-size: clamp(13px, 1.1vw, 18px); color: #555d68; font-weight: 500;
  ...
  @keyframes bump {
    0% { transform: scale(1); }
    40% { transform: scale(1.2); color: #3fb950; }
  ...
  .img-pill.active {
    color: #58a6ff; border-color: rgba(88,166,255,0.35);
    box-shadow: 0 2px 8px rgba(0,0,0,.5), 0 8px 30px rgba(0,0,0,.45), 0 0 20px rgba(88,166,255,0.12), inset 0 1px 0 rgba(88,166,255,0.1);
  }
  ...
  .thumbs-wrap {
    ...
    background: linear-gradient(to bottom, rgba(8,9,12,0), rgba(8,9,12,1) 30%);
  }
  .thumbs {
    display: flex; gap: 8px; overflow-x: auto; padding: 0 20px;
    scrollbar-width: thin; scrollbar-color: #1e222c transparent;
    scroll-behavior: smooth;
  }
  .thumbs::-webkit-scrollbar { height: 3px; }
  .thumbs::-webkit-scrollbar-track { background: transparent; }
  .thumbs::-webkit-scrollbar-thumb { background: #1e222c; border-radius: 3px; }
  .thumb {
