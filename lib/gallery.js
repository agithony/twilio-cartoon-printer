...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @keyframes reveal-sketch { 0% { filter: grayscale(1) contrast(2); } 100% { filter: grayscale(0) contrast(1); } }
  ...
  #mainImg.reveal-sketch-to-color { animation: reveal-sketch 2s ease-out forwards; }
