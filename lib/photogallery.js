...
.mg-card.selected { border-color: #4a9eff; }
.mg-card .mg-check {
...
.mg-card .mg-label {
  padding: 6px 8px; font-family: 'Inter', sans-serif; font-size: 10px;
...
.mg-type-tag.ai { background: rgba(100,160,255,0.15); color: #6ea8ff; }
.mg-type-tag.selfie { background: rgba(255,180,100,0.15); color: #ffb464; }
...
.action-bar .ab-count strong { color: #c8a96e; }
.ab-btn {
...
.toast {
  ...
  font-family: 'Inter', sans-serif; font-size: 13px; color: #c8a96e;
...
.mg-empty {
  ...
  font-family: 'Inter', sans-serif; font-size: 14px; color: rgba(210,195,175,0.3);
  font-style: italic;
}
`;
