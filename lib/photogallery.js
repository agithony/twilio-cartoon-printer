...
function onEventChange() {
  ...
  stopAuto();
  // Cancel any in-flight new-photo hold — it was tied to the previous
  // event. Otherwise the timer fires 20s later and resumes autoplay on
  // whatever event the user is now viewing.
