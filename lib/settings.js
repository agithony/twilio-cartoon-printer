...
function update(changes) {
    ...
    if (newEventName !== oldEventName) {
        ...
        // Debug: log what adminPhones ended up as after switch
        console.log(`⚙️  Event switch debug: adminPhones in perEventOverrides=${JSON.stringify(perEventOverrides.adminPhones || "not-set")}, final=${JSON.stringify(get("adminPhones"))}`);
