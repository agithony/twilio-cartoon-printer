...
function getAllForUser(email) {
    ...
    // Filter out USER_EXCLUDED_KEYS from user overrides — those are controlled
    // globally and stale values in the user file must not override them.
    const filtered = {};
    ...
    return { ...DEFAULTS, ...overrides, ...filtered };
}
