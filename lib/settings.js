...
function get(key) {
    ...
    if (key === "contentTemplates") return { ...DEFAULTS.contentTemplates, ...(overrides.contentTemplates || {}) };
...
function getAll() {
    return { ...DEFAULTS, ...overrides, contentTemplates: get("contentTemplates"), leadCaptureFields: getLeadFields() };
}
...
function getContentSid(key, locale = "en") {
    const templates = { ...(DEFAULTS.contentTemplates || {}), ...(overrides.contentTemplates || {}) };
