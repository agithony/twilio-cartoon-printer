...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Action cards */
  .actions { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 40px; }
...
<div class="section">
  ...
  <div class="steps">
    <div class="step"><div class="step-num">1</div><div class="step-text">Configure your event, styles, and printer in Settings above</div></div>
    <div class="step"><div class="step-num">2</div><div class="step-text">Launch the Booth Display on a monitor for attendees to see</div></div>
    ...
    <div class="step"><div class="step-num">4</div><div class="step-text">AI generates their portrait and it prints at your booth</div></div>
