...
<div class="section">
  ...
  <div class="settings-panel" id="settingsPanel">
    ...
    <div id="userSettingsBanner" style="background:rgba(59,130,246,.08);border:1px solid rgba(59,130,246,.25);border-radius:10px;padding:12px 16px;margin-bottom:16px;display:flex;align-items:center;gap:10px">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
      <span style="font-size:13px;color:#93c5fd">Personal Settings Mode — your changes won't affect the live SMS/print pipeline or other admins until you <strong>Save Globally</strong>.</span>
    </div>
