...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .style-prompt { display: none; margin-top: 8px; padding: 8px 10px; border-radius: 6px; background: #0B0D11; border: 1px solid #1A1E27; font-size: 11px; color: #636B78; line-height: 1.5; white-space: pre-wrap; word-break: break-word; }
...
function renderStyles() {
  ...
  _builtInStyles.forEach(function(s, i) {
    ...
    html += '<div class="style-card' + (isDisabled ? ' disabled' : '') + '">'
      ...
      + '<label class="toggle-sw"><input type="checkbox" data-style="' + s.key + '" ' + checked + ' onchange="this.closest(\\'.style-card\\').classList.toggle(\\'disabled\\',!this.checked)"><span class="slider"></span></label>'
      + '</div>'
  ...
  Object.keys(_customStyles).forEach(function(k) {
    html += '<div class="style-card">'
      ...
      + '<div class="style-card-body">'
      + '<div class="style-card-header"><span class="sname">' + escHtml(_customStyles[k].name) + '</span><span class="slabel">custom</span></div>'
      + '<div class="style-card-actions">'
