...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero h1 { font-size: 30px; font-weight: 700; color: #F7F8F8; letter-spacing: -0.5px; }
  .hero .subtitle { font-size: 16px; color: #636B78; font-weight: 400; margin-top: 8px; }
  ...
  .action-card h2 { font-size: 17px; font-weight: 600; color: #E8EAED; margin-bottom: 8px; }
  .action-card p { font-size: 14px; color: #636B78; line-height: 1.6; }
  ...
  .section-title {
    font-size: 12px; font-weight: 600; color: #4D5562;
    text-transform: uppercase; letter-spacing: 1px; margin-bottom: 16px;
    padding-bottom: 12px; border-bottom: 1px solid #1A1E27;
  }
  ...
  .step-text { font-size: 13px; color: #8B95A5; line-height: 1.5; }
  ...
  .footer {
    ...
    margin-top: 48px; padding-top: 24px; border-top: 1px solid #1A1E27;
  }
  .footer a { color: #636B78; text-decoration: none; }
  .footer a:hover { color: #8B95A5; }
  ...
  .settings-toggle {
    ...
    margin-bottom: 16px; transition: border-color .2s; user-select: none;
  }
  .settings-toggle:hover { border-color: #2A3040; }
  .settings-toggle h3 { font-size: 12px; font-weight: 600; color: #4D5562; text-transform: uppercase; letter-spacing: 1px; }
  ...
  .sg { background: #13161D; border: 1px solid #1E222B; border-radius: 12px; padding: 24px; margin-bottom: 12px; }
  .sg h4 { font-size: 16px; font-weight: 600; color: #E8EAED; margin-bottom: 16px; padding-left: 12px; border-left: 3px solid #F22F46; line-height: 1; padding-top: 2px; padding-bottom: 2px; }
  ...
  .sg-group-header::after { content: ''; flex: 1; height: 1px; background: #1E222B; }
  .sg-group:nth-child(2) .sg h4 { border-left-color: #4B8BF5; }
  .sg-group:nth-child(3) .sg h4 { border-left-color: #2EBA54; }
  .sg-group:nth-child(4) .sg h4 { border-left-color: #E8853A; }
  .sf { margin-bottom: 16px; }
  .sf:last-child { margin-bottom: 0; }
  .sf label { display: block; font-size: 13px; color: #636B78; margin-bottom: 8px; font-weight: 500; }
  .sf input[type="text"], .sf input[type="number"], .sf input[type="url"], .sf input[type="password"], .sf select, .sf textarea {
    width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid #252A34;
  ...
  .combo-arrow {
    ...
    background: none; border: none; cursor: pointer; color: #4D5562;
    display: flex; align-items: center; justify-content: center;
    border-radius: 0 8px 8px 0; transition: color .15s;
  }
  .combo-arrow:hover { color: #B0B8C4; }
  .combo-dropdown {
    display: none; position: absolute; left: 0; right: 0; top: 100%; margin-top: 4px;
    background: #1A1E27; border: 1px solid #313845; border-radius: 8px;
  ...
  .combo-dropdown .combo-item {
    padding: 9px 14px; font-size: 14px; color: #B0B8C4; cursor: pointer;
  ...
  .combo-dropdown .combo-item:hover, .combo-dropdown .combo-item.active { background: #252A34; color: #E8EAED; }
  .combo-dropdown .combo-item .combo-current { font-size: 11px; color: #4B8BF5; margin-left: 6px; }
  .combo-dropdown .combo-empty { padding: 9px 14px; font-size: 13px; color: #4D5562; font-style: italic; }
  ...
  .preview-box img { max-width: 100%; max-height: 200px; border-radius: 8px; border: 1px solid #1E222B; background: #0B0D11; }
  .preview-box video { max-width: 100%; max-height: 160px; border-radius: 8px; border: 1px solid #1E222B; background: #0B0D11; }
  .preview-box .no-preview { font-size: 12px; color: #4D5562; font-style: italic; }
  ...
  .style-card-header .sname { font-size: 14px; font-weight: 600; color: #B0B8C4; }
  .style-card-header input.sname-edit { font-size: 14px; font-weight: 600; color: #B0B8C4; background: transparent; border: 1px solid transparent; border-radius: 4px; padding: 1px 4px; font-family: inherit; width: 100%; transition: border-color .2s; }
  ...
  .style-card-header .slabel { font-size: 11px; color: #4D5562; }
  ...
  .delivery-switch button {
    flex: 1; padding: 11px 16px; border: none; cursor: pointer; font-size: 14px; font-weight: 600;
  ...
  .delivery-status { font-size: 12px; margin-top: 8px; padding: 6px 12px; border-radius: 6px; }
  ...
  .phone-tag { display: inline-flex; align-items: center; gap: 5px; padding: 6px 12px; border-radius: 6px; background: #1A1E27; color: #B0B8C4; font-size: 13px; }
  ...
  .btn { padding: 10px 20px; border-radius: 8px; border: 1px solid #252A34; background: #1A1E27; color: #B0B8C4; font-size: 14px; font-weight: 500; cursor: pointer; transition: all .15s; font-family: inherit; }
  ...
  .settings-actions {
    ...
    background: #13161Dee; backdrop-filter: blur(8px);
    border: 1px solid #1E222B; border-radius: 12px;
...
<div class="section">
  ...
  <div class="settings-panel" id="settingsPanel">
    ...
    <div class="sg-group">
    <div class="sg-group-header">API Configuration</div>
    ...
    <div class="sg-group">
    <div class="sg-group-header">Event Setup</div>
    ...
    <div class="sg"><h4>Delivery &amp; Printing <span class="tip" data-tip="Configure delivery mode and physical printer settings. Disable printing to run digital-only (no printer required).">?</span></h4>
      ...
      <div id="printerSection">
        <div class="sf">
          ...
          <div id="printerChecklist" style="margin-bottom:8px"><div style="display:flex;align-items:center;gap:8px;padding:8px 0"><svg width="16" height="16" viewBox="0 0 24 24" style="animation:spin 1s linear infinite;color:#4D5562"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="3" fill="none" stroke-dasharray="30 70" stroke-linecap="round"/></svg><span style="color:#636B78;font-size:13px">Detecting printers...</span></div></div>
          <div style="display:flex;align-items:center;gap:12px">
            <button class="btn btn-sm" onclick="refreshPrinters()">Refresh</button>
            <span id="printerCount" style="font-size:13px;color:#636B78"></span>
          </div>
        </div>
      </div>
    ...
    <div class="sg"><h4>Booth Display <span class="tip" data-tip="Configure what attendees see on the booth monitor — template overlays, intro video, and legal terms.">?</span></h4>
      <div class="sf-row">
        <div class="sf">
    ...
    <div class="sg-group">
    <div class="sg-group-header">Engagement</div>
...
function buildEventDropdown(filter) {
  ...
  if (matches.length === 0) {
    dd.innerHTML = '<div class="combo-empty">No existing events' + (query ? ' matching "' + escHtml(filter) + '"' : '') + '</div>';
    return;
  }
...
function openEventDropdown() {
  if (_knownEvents.length === 0) return;
  var dd = document.getElementById("eventDropdown");
...
function renderPrinterChecklist(printers, active) {
  ...
  if (!printers || printers.length === 0) {
    container.innerHTML = '<span style="color:#636B78">No printers detected</span>';
...
async function refreshPrinters() {
  var container = document.getElementById("printerChecklist");
  container.innerHTML = '<div style="display:flex;align-items:center;gap:8px;padding:8px 0"><svg width="16" height="16" viewBox="0 0 24 24" style="animation:spin 1s linear infinite;color:#4D5562"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="3" fill="none" stroke-dasharray="30 70" stroke-linecap="round"/></svg><span style="color:#636B78;font-size:13px">Refreshing...</span></div>';
  try {
