...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @keyframes review-pulse {
    0%, 100% { border-color: #f0983a; box-shadow: 0 0 8px rgba(240,152,58,0.15); }
    50% { border-color: #F22F46; box-shadow: 0 0 20px rgba(242,47,70,0.25); }
  }
  .review-banner {
    background: #1a2030; border: 2px solid #f0983a; border-radius: 12px;
  ...
  .review-icon { font-size: 22px; color: #f0983a; }
  .review-badge {
    font-size: 12px; background: #F22F46; color: #fff;
  ...
  .rv-card {
    background: #141a26; border-radius: 8px; padding: 12px; text-align: center;
    border: 1px solid #252d3a; transition: border-color .2s;
  }
  .rv-card:hover { border-color: #f0983a; }
  .rv-card img { width: 100%; border-radius: 6px; margin-bottom: 8px; cursor: pointer; }
  .rv-meta { font-size: 11px; color: #94a0b0; margin-bottom: 10px; }
  .rv-actions { display: flex; flex-direction: column; gap: 6px; }
  .rv-btn {
    border: none; border-radius: 6px; padding: 8px 12px; cursor: pointer;
    font-size: 12px; font-weight: 600; color: #fff; transition: all .15s;
    width: 100%; text-align: center;
  }
  .rv-btn:hover { transform: translateY(-1px); box-shadow: 0 2px 8px rgba(0,0,0,.3); }
  .rv-btn:active { transform: translateY(0); }
  .rv-btn-approve { background: #3cc968; font-size: 13px; padding: 10px 12px; }
  .rv-reject-row { display: flex; gap: 6px; }
  .rv-reject-row .rv-btn { font-size: 11px; padding: 6px 8px; }
  .rv-btn-reject { background: transparent; border: 1px solid #525c6c; color: #94a0b0; }
  .rv-btn-reject:hover { border-color: #F22F46; color: #F22F46; background: rgba(242,47,70,.08); }
  .rv-btn-notify { background: transparent; border: 1px solid #525c6c; color: #94a0b0; }
  .rv-btn-notify:hover { border-color: #f0983a; color: #f0983a; background: rgba(240,152,58,.08); }
  .rv-btn-reanalyze { background: transparent; border: 1px solid #525c6c; color: #94a0b0; }
  .rv-btn-reanalyze:hover { border-color: #7c6ef6; color: #7c6ef6; background: rgba(124,110,246,.08); }

  /* Bulk selection */
  .rv-card-check {
    position: absolute; top: 8px; left: 8px; z-index: 2;
    width: 20px; height: 20px; accent-color: #3cc968; cursor: pointer;
  }
  .rv-card { position: relative; }
  .rv-card.rv-selected { border-color: #3cc968; box-shadow: 0 0 0 1px #3cc968; }
  .rv-bulk-bar {
    display: none; align-items: center; gap: 10px; flex-wrap: wrap;
    margin-bottom: 12px; padding: 10px 14px;
    background: #141a26; border: 1px solid #252d3a; border-radius: 8px;
  }
  .rv-bulk-bar.active { display: flex; }
  .rv-bulk-bar label { font-size: 13px; color: #94a0b0; cursor: pointer; display: flex; align-items: center; gap: 6px; }
  .rv-bulk-bar label input { accent-color: #3cc968; cursor: pointer; }
  .rv-bulk-count { font-size: 12px; color: #f0983a; font-weight: 600; }
  ...
  .rv-modal-close {
    ...
    background: #1a2030; color: #fff; border: 2px solid #525c6c;
    width: 32px; height: 32px; border-radius: 50%; font-size: 18px;
    cursor: pointer; display: flex; align-items: center; justify-content: center;
    line-height: 1;
  }
  .rv-modal-close:hover { background: #F22F46; border-color: #F22F46; }
</style>
</head>
<body>
...
<div class="wrap">
  <div class="header">
    ...
    <div class="header-links">
      ...
      <a href="#" onclick="fetch('/auth/logout',{method:'POST'}).then(()=>location='/auth/login');return false"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>Logout</a>
    </div>
  </div>
