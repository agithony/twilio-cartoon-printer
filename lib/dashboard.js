...
router.post("/api/settings/upload", (req, res) => {
    ...
    req.on("end", () => {
        ...
        writeStream.end(async () => {
            ...
            const files = type === "template" ? await settings.listTemplates() : type === "brand-reference" ? settings.listBrandReferences() : type === "style-reference" ? settings.listStyleReferences() : type === "background-reference" ? settings.listBackgroundReferences() : type === "video" ? settings.listVideos() : [];
