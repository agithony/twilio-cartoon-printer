...
function renderReviewQueue(jobs) {
  ...
  grid.innerHTML = h;
  // Restore open feedback panels
  for (var f in _openFeedback) {
    var panel = document.getElementById("rvfb-"+f);
    if (panel) { panel.classList.add("open"); panel.querySelector("textarea").value = _openFeedback[f]; }
  }
