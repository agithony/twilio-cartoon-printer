...
function renderFailedRow(j) {
  ...
  // Selfie thumb — the AI output never existed for failures, but the input
  // selfie is usually on disk (for moderation / face / multi-subject fails
  // it always is). onerror hides the img gracefully if file is missing.
  if (j.filePrefix && j.eventName) {
    ...
    h += '<a class="jb-thumb-link" href="'+thumbUrl+'" target="_blank" rel="noopener" title="Original selfie"><img class="jb-thumb" src="'+thumbUrl+'" loading="lazy" alt="" onerror="this.parentElement.classList.add(&apos;jb-thumb-empty&apos;);this.remove()"></a>';
  } else {
...
function renderDoneRow(j) {
  ...
  if (j.filePrefix && j.eventName) {
    ...
    h += '<a class="jb-thumb-link" href="'+thumbUrl+'" target="_blank" rel="noopener" title="Portrait"><img class="jb-thumb" src="'+thumbUrl+'" loading="lazy" alt="" onerror="this.parentElement.classList.add(&apos;jb-thumb-empty&apos;);this.remove()"></a>';
  } else {
    h += '<span class="jb-thumb-empty"></span>';
  }
  h += '<span class="jb-phone">'+escHtml(j.phone)+'</span>';
