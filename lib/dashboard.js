...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .header h1 { font-size: clamp(20px, 1.6vw, 28px); font-weight: 700; color: #F7F8F8; letter-spacing: -0.3px; }
  ...
  .event-picker-label { font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: .8px; color: #4D5562; padding-left: 2px; }
  .event-select {
    background: #13161D;
    color: #F7F8F8;
  ...
  .admin-toggle {
    ...
    font-size: 12px; color: #636B78; user-select: none; white-space: nowrap;
  }
  .admin-toggle input { accent-color: #F22F46; cursor: pointer; }
  .admin-toggle:hover .admin-toggle-label { color: #B0B8C4; }
  .btn-report {
  ...
  .card .label { font-size: clamp(10px, 0.8rem, 14px); color: #636B78; margin-top: 6px; text-transform: uppercase; letter-spacing: .6px; font-weight: 500; }
  ...
  .panel h2 { font-size: 12px; font-weight: 600; color: #4D5562; text-transform: uppercase; letter-spacing: 1px; margin-bottom: clamp(12px, 1.2vw, 20px); }
  ...
  .paper-alert.warning, .stuck-alert.warning { display: block; background: #E8853A22; color: #E8853A; border: 1px solid #E8853A44; }
  .paper-alert.empty { display: block; background: #E0444422; color: #F22F46; border: 1px solid #E0444444; }
  .stuck-alert.error { display: block; background: #E0444422; color: #F22F46; border: 1px solid #E0444444; }
  ...
  /* Printer */
  .printer-status { display: flex; align-items: center; gap: 10px; font-size: 0.95rem; margin-bottom: 6px; }
...
<div class="header">
  ...
  <div class="header-right">
    ...
    <label class="admin-toggle" title="When checked, prints from admin phone numbers are excluded from all metrics"><input type="checkbox" id="excludeAdminCb" onchange="onAdminToggle()"><span class="admin-toggle-label">Exclude admin</span></label>
...
<div class="grid">
  ...
  <div class="panel">
    ...
    <div style="display:flex;gap:clamp(16px,2vw,32px);flex-wrap:wrap;margin-top:16px;padding-top:14px;border-top:1px solid #1E222B">
      <div><span style="font-size:clamp(18px,1.6vw,28px);font-weight:700;color:#9B6FE8" id="avgGenTime">--</span><div style="font-size:0.85rem;color:#636B78;margin-top:4px">Avg Generation</div></div>
      <div><span style="font-size:clamp(18px,1.6vw,28px);font-weight:700;color:#2EBA54" id="avgPrintTime">--</span><div style="font-size:0.85rem;color:#636B78;margin-top:4px">Avg Print</div></div>
    </div>
  </div>
</div>
...
<div class="grid">
  ...
  <!-- Paper Counter -->
  <div class="panel">
    <h2>Paper Counter <span style="font-size:9px;font-weight:400;text-transform:none;letter-spacing:0;color:#636B78">(Estimated)</span></h2>
    ...
    <div style="text-align:center;font-size:0.75rem;color:#4D5562;margin-bottom:12px">Based on prints sent -- press Reset after reloading tray</div>
