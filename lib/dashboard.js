...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .rv-meta { font-size: 11px; color: #94a0b0; margin-bottom: 8px; }
  .rv-actions { display: flex; gap: 6px; justify-content: center; }
  .rv-btn {
    border: none; border-radius: 4px; padding: 7px 16px; cursor: pointer;
    font-size: 12px; font-weight: 600; color: #fff; transition: opacity .2s;
  }
  .rv-btn:hover { opacity: .85; }
  .rv-btn-approve { background: #3cc968; }
  .rv-btn-reject { background: #F22F46; }
  .rv-btn-notify { background: #f0983a; }
</style>
</head>
<body>
...
function renderReviewQueue(jobs) {
  ...
  for (var j of jobs) {
    ...
    h += '<img src="'+imgSrc+'" onclick="window.open(\\'/images/'+fp+'_output.png\\',\\'_blank\\')" title="Click to view full size">';
