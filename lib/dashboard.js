...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .header h1 { font-size: clamp(16px, 1.4vw, 24px); font-weight: 600; color: #f0f6fc; }
  .header-right { display: flex; align-items: center; gap: clamp(6px, 0.7vw, 12px); }
  .event-select {
    background: #161b22;
    color: #f0883e;
  ...
  .btn-report {
    ...
    border-radius: 8px; padding: 5px 12px; font-size: clamp(11px, 0.85rem, 14px); cursor: pointer;
    font-family: inherit; transition: background .15s, border-color .15s;
  }
  .btn-report:hover { background: #a371f718; border-color: #a371f7; }
  .btn-home {
    background: #161b22; color: #3fb950; border: 1px solid #3fb95044;
    border-radius: 8px; padding: 5px 12px; font-size: clamp(11px, 0.85rem, 14px);
    font-family: inherit; text-decoration: none; transition: background .15s, border-color .15s;
  }
  .btn-home:hover { background: #3fb95018; border-color: #3fb950; }
  .status-dot {
  ...
  .cards { display: grid; grid-template-columns: repeat(auto-fit, minmax(clamp(120px, 12vw, 200px), 1fr)); gap: clamp(10px, 1vw, 16px); margin-bottom: clamp(16px, 2vw, 28px); }
  .card {
    background: #12151c;
    border: 1px solid #1b1f27;
    border-top: 3px solid #21262d;
    border-radius: 10px;
    padding: clamp(12px, 1.2vw, 20px) clamp(10px, 1vw, 16px);
    text-align: center;
  ...
  .card .value { font-size: clamp(22px, 2.2vw, 40px); font-weight: 700; color: #f0f6fc; font-variant-numeric: tabular-nums; }
  .card .label { font-size: clamp(9px, 0.75rem, 13px); color: #6e7681; margin-top: 6px; text-transform: uppercase; letter-spacing: .6px; font-weight: 500; }

  .grid { display: grid; grid-template-columns: 1fr 1fr; gap: clamp(10px, 1.1vw, 18px); margin-bottom: clamp(14px, 1.6vw, 24px); }
  ...
  .panel h2 { font-size: clamp(10px, 0.78rem, 13px); font-weight: 600; color: #6e7681; text-transform: uppercase; letter-spacing: .7px; margin-bottom: clamp(10px, 1.1vw, 18px); }
  ...
  .paper-sub { text-align: center; font-size: 0.9rem; color: #6e7681; margin: 4px 0 12px; }
  ...
  .paper-controls label { font-size: 0.85rem; color: #6e7681; }
  .paper-controls input {
    width: 56px; background: #0a0c10; border: 1px solid #1b1f27; border-radius: 6px;
    color: #e1e4e8; padding: 4px 8px; font-size: 0.9rem; text-align: center;
  }
  ...
  .style-name { width: clamp(60px, 6vw, 100px); font-size: 0.85rem; color: #6e7681; text-align: right; flex-shrink: 0; }
  .style-bar-bg { flex: 1; height: clamp(14px, 1.3vw, 22px); background: #1b1f27; border-radius: 4px; overflow: hidden; }
  ...
  .hourly-tip {
    ...
    background: #272d37; color: #f0f6fc; font-size: 0.78rem; font-weight: 600; padding: 4px 10px;
  ...
  .hourly-label { flex: 1; font-size: clamp(7px, 0.6rem, 11px); color: #3d434d; text-align: center; white-space: nowrap; }
  ...
  /* Top users */
  .user-row { display: flex; justify-content: space-between; padding: 7px 0; font-size: 0.9rem; border-bottom: 1px solid #1b1f27; }
  .user-row:last-child { border-bottom: none; }
  .user-phone { color: #6e7681; font-family: monospace; font-size: 0.85rem; }
  ...
  .fail-name { width: clamp(75px, 7vw, 110px); font-size: 0.85rem; color: #6e7681; text-align: right; flex-shrink: 0; }
  .fail-bar-bg { flex: 1; height: clamp(14px, 1.3vw, 22px); background: #1b1f27; border-radius: 4px; overflow: hidden; }
  ...
  .geo-name { width: clamp(90px, 9vw, 150px); font-size: 0.85rem; color: #6e7681; text-align: right; flex-shrink: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
  .geo-bar-bg { flex: 1; height: clamp(14px, 1.3vw, 22px); background: #1b1f27; border-radius: 4px; overflow: hidden; }
...
<div class="wrap">
<div class="header">
  <h1><span class="status-dot" id="liveDot" style="background:#3fb950"></span> Admin Dashboard</h1>
...
<div class="grid">
  ...
  <div class="panel">
    <h2>Job Health</h2>
    <div style="display:flex;gap:clamp(12px,1.6vw,28px);flex-wrap:wrap">
      <div><span style="font-size:clamp(20px,1.8vw,34px);font-weight:700;color:#3fb950" id="healthDone">--</span><div style="font-size:0.85rem;color:#8b949e;margin-top:2px">Completed</div></div>
      <div><span style="font-size:clamp(20px,1.8vw,34px);font-weight:700;color:#f85149" id="healthFailed">--</span><div style="font-size:0.85rem;color:#8b949e;margin-top:2px">Failed</div></div>
      <div><span style="font-size:clamp(20px,1.8vw,34px);font-weight:700;color:#58a6ff" id="healthRate">--</span><div style="font-size:0.85rem;color:#8b949e;margin-top:2px">Success Rate</div></div>
      <div><span style="font-size:clamp(20px,1.8vw,34px);font-weight:700;color:#f0883e" id="healthModRate">--</span><div style="font-size:0.85rem;color:#8b949e;margin-top:2px">Rejection Rate</div></div>
    </div>
  </div>
</div>
