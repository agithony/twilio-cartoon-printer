...
router.get("/api/report", async (req, res) => {
    ...
    if (dubAnalytics) {
        ...
        doc.font("TwilioDisplay").fontSize(22).fillColor(ink)
            .text(String(dubAnalytics.totalClicks), mx);
        doc.font("TwilioText").fontSize(9).fillColor(gray500)
            .text("Total link clicks  |  Click-through rate: " + ctr, mx);
        doc.moveDown(0.6);
  ...
  <div class="grid">
    <div class="panel" style="grid-column:1/-1">
      ...
      <div class="link-summary">
        <div class="link-stat"><span class="link-stat-val" id="dubTotalClicks">--</span><span class="link-stat-lbl">Total Clicks</span></div>
        <div class="link-stat"><span class="link-stat-val" id="dubCtr">--</span><span class="link-stat-lbl">Click-Through Rate</span></div>
      </div>
