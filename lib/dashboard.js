...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .header-left h1 { font-size: clamp(18px, 1.5vw, 26px); font-weight: 700; color: #F7F8F8; letter-spacing: -0.3px; }
  .header-left a { color: #636B78; text-decoration: none; font-size: 13px; font-weight: 500; padding: 4px 12px; border-radius: 8px; transition: color .15s, background .15s; }
  .header-left a:hover { color: #B0B8C4; background: #13161D; }
  .header-right { display: flex; align-items: center; gap: clamp(8px, 1vw, 14px); }
  .event-select {
    background: #13161D;
    color: #B0B8C4;
  ...
  .event-select:focus { outline: none; border-color: #4B8BF5; }
  ...
  /* Outreach section */
  .outreach-panel { background: #13161D; border: 1px solid #1E222B; border-radius: 14px; margin-bottom: 24px; overflow: hidden; }
  .outreach-header {
    display: flex; align-items: center; gap: 12px; cursor: pointer; user-select: none;
    padding: 16px 20px; background: #13161D; transition: background .15s;
  }
  .outreach-header:hover { background: #1A1E27; }
  .outreach-header h2 { margin: 0; font-size: 14px; font-weight: 600; color: #B0B8C4; text-transform: uppercase; letter-spacing: .5px; }
  .outreach-badge { background: #4B8BF522; color: #4B8BF5; font-size: 11px; font-weight: 600; padding: 2px 10px; border-radius: 10px; }
  .outreach-toggle { margin-left: auto; font-size: 12px; color: #8B95A5; transition: transform .2s; }
  ...
  .outreach-toolbar label { font-size: 13px; color: #8B95A5; display: flex; align-items: center; gap: 6px; cursor: pointer; }
  .outreach-sel-count { font-size: 12px; color: #4B8BF5; }
  .outreach-list {
    max-height: 360px; overflow-y: auto; border: 1px solid #1E222B; border-radius: 8px;
    scrollbar-width: thin; scrollbar-color: #252A34 #13161D;
  }
  .outreach-list::-webkit-scrollbar { width: 6px; }
  .outreach-list::-webkit-scrollbar-track { background: #13161D; border-radius: 3px; }
  .outreach-list::-webkit-scrollbar-thumb { background: #252A34; border-radius: 3px; }
  .outreach-list::-webkit-scrollbar-thumb:hover { background: #2A3040; }
  .outreach-row {
  ...
  .outreach-row:hover { background: #1A1E27; }
  .outreach-row.winner { background: #E8853A18; border-left: 3px solid #E8853A; }
  .outreach-row input[type=checkbox] { accent-color: #4B8BF5; cursor: pointer; flex-shrink: 0; }
  .outreach-phone { font-family: monospace; color: #B0B8C4; min-width: 120px; }
  .outreach-count { color: #8B95A5; min-width: 70px; }
  ...
  .outreach-time { color: #4D5562; font-size: 11px; min-width: 60px; text-align: right; flex-shrink: 0; }
  ...
  .outreach-compose-label { font-size: 12px; color: #8B95A5; text-transform: uppercase; letter-spacing: .5px; margin-bottom: 8px; }
  .outreach-compose-row { display: flex; gap: 8px; align-items: flex-start; }
  .outreach-compose textarea {
    flex: 1; background: #0B0D11; border: 1px solid #1E222B; border-radius: 8px;
    color: #B0B8C4; padding: 10px 14px; font-size: 13px; font-family: inherit; resize: vertical; min-height: 68px;
  }
  .outreach-compose textarea:focus { outline: none; border-color: #4B8BF5; }
  .outreach-compose textarea::placeholder { color: #4D5562; }
  .outreach-result { font-size: 12px; padding: 8px 12px; border-radius: 6px; margin-top: 10px; display: none; }
  .outreach-result.success { display: block; background: #2EBA5422; color: #2EBA54; border: 1px solid #2EBA5444; }
  .outreach-result.error { display: block; background: #E0444422; color: #F22F46; border: 1px solid #E0444444; }
  .outreach-result.info { display: block; background: #E8853A18; color: #E8853A; border: 1px solid #E8853A44; }
  .btn-raffle { background: #E8853A22; color: #E8853A; border: 1px solid #E8853A44; }
  .btn-raffle:hover { background: #E8853A33; }
...
<div class="outreach-panel">
  ...
  <div class="outreach-body" id="outreachBody">
    <div class="outreach-actions">
      <label style="font-size:13px;color:#8B95A5;display:flex;align-items:center;gap:6px;cursor:pointer"><input type="checkbox" id="outreachSelectAll" onchange="toggleSelectAll()"> Select All</label>
...
function renderUsers() {
  ...
  document.getElementById("outreachList").innerHTML = html || '<div style="padding:16px;color:#4D5562;text-align:center">No recipients yet</div>';
  updateSelCount();
}
