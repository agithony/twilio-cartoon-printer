...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .jb-name { color: var(--th-text); font-weight: 600; font-size: 12px; width: 120px; flex-shrink: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
  .jb-style { color: var(--th-text-muted); width: 80px; flex-shrink: 0; }
  .jb-printer { color: var(--th-text-muted); font-size: 11px; width: 100px; flex-shrink: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
  ...
  .user-name { color: var(--th-text); font-weight: 600; font-size: 13px; width: 140px; flex-shrink: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
  .user-count { font-weight: 700; font-variant-numeric: tabular-nums; font-size: 13px; color: var(--th-text); font-family: 'Twilio Sans Mono', monospace; white-space: nowrap; width: 90px; flex-shrink: 0; }
  ...
  .du-actions { display: flex; gap: 4px; flex-shrink: 0; margin-left: auto; }
