...
async function generateImage(job) {
    ...
    if (scene.subjects > 1 && scene.pets !== "none") {
        ...
        sceneLine = "This photo has exactly ONE person. Generate ONLY this one person — do not add, invent, or hallucinate any additional people.";
    }
    ...
    if (scene.subjects === 1 && scene.pets === "none") {
        fullPrompt += "\n\nFINAL REMINDER: There is exactly ONE person in this photo. The output must contain ONLY this one person. Do not add any other people.";
    } else if (scene.subjects === 1 && scene.pets !== "none") {
        fullPrompt += `\n\nFINAL REMINDER: There is exactly ONE person and a ${scene.pets} in this photo. Do not add any other people.`;
    }
