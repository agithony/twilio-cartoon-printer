...
async function generateImage(job) {
    ...
    if (scene.subjects > 1) {
        ...
        if (multiMode === "caricature") {
            ...
            fullPrompt += "\n\nIMPORTANT: This has multiple people. Make each person a fun, exaggerated CARICATURE — larger expressive eyes, playful proportions, pronounced features, whimsical energy. The caricature should still capture the essence and recognizable traits of each person (hair, glasses, facial hair, skin tone) but in a deliberately stylized, cartoon-like way. Prioritize fun and character over photographic accuracy.";
        }
    }
