...
async function _runAnalysis(imageBuffers, type) {
    const prompts = {
        style: `Analyze these reference images and describe the art style in precise detail. Focus on:
- Rendering technique (vector, hand-drawn, digital painting, 3D, watercolor, etc.)
- Line work (thick outlines, thin lines, no outlines, sketchy, clean, etc.)
- Color palette (specific dominant colors, saturation level, warm/cool)
- Shading style (flat/cel-shaded, soft gradients, textured, cross-hatched)
- Proportions and stylization level (realistic, semi-realistic, chibi, caricature)
- Texture and detail level (smooth, gritty, minimalist, ornate)
- Overall mood/aesthetic (playful, corporate, edgy, whimsical, elegant)
Be specific and technical. This description will be used to instruct an AI image generator to replicate this exact style.`,
        brand: `Analyze these reference images showing branded clothing/gear. Describe in precise detail:
- Type of clothing/gear shown (t-shirt, jersey, jacket, hat, uniform, etc.)
- Colors and color placement (primary color, accent colors, where each appears)
- Logos, text, or graphics (describe what they look like, their position, size, and style)
- Patterns or design elements (stripes, gradients, geometric shapes, etc.)
- Material appearance (cotton, athletic mesh, leather, metallic, etc.)
- Fit and style (casual, athletic, formal, oversized, fitted, etc.)
- Any accessories (hats, badges, wristbands, lanyards, etc.)
Be specific and visual. This description will instruct an AI to dress a person in this exact outfit.`,
        background: `Analyze these reference images showing a background/environment. Describe in precise detail:
- Setting type (indoor, outdoor, abstract, urban, natural, futuristic, etc.)
- Key visual elements (buildings, trees, patterns, objects, gradients, etc.)
- Color scheme (dominant colors, accent colors, warm/cool tones)
- Lighting (bright, moody, sunset, neon, soft, dramatic, etc.)
- Depth and perspective (flat, layered, deep perspective, overhead, etc.)
- Texture and style (photographic, illustrated, geometric, organic, etc.)
- Overall atmosphere and mood
Be specific and visual. This description will instruct an AI to recreate this background behind a portrait.`,
    };
